...
const Seventh = () => {
  return (
    <article className='p-[20px_80px] text-center ph:p-[20px_30px]'>
        <h1 className='text-center text-[40px] font-semibold mb-[40px] ph:text-[25px] md:text-[30px] ph:mb-[30px]'>О КОМПАНИИ</h1>
        <div className='flex gap-[50px] items-center md:block'>
            <div className='w-[40%] md:w-[100%]'>
                <img src={img1} alt="" />
            </div>
            <div className='w-[48%] md:w-[100%]'>
                <p className='mb-[30px] text-start md:mt-[20px] md:mb-[20px]'>Сегодня – это крупнейшая компания в Старом Осколе с широким спектром телекоммуникационных услуг: Интернет, телефония, IP телевидение, видеонаблюдение.</p>
