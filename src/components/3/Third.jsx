  ...
  return (
    <section className='text-center bg-[#F1F2F4] p-[40px]'>
        ...
        <div className='bg-white'>
            <div className='flex justify-between p-[40px_80px] mb-[40px] md:flex-wrap ph:p-[10px_20px] md:text-start'>
            ...
            <div className='grid grid-cols-[200px_200px_240px_200px_200px] justify-center gap-[30px] mb-[40px] overflow-auto'>
                <div className='h-[200px] text-start mt-[44px]'>
                ...
                <div className='h-[270px] text-start bg-[#273158] text-[white] p-[20px] rounded-lg mt-[0px]'>
