  ...
  return (
    <section className="p-[20px_80px] ph:p-[10px] md:p-[20px_40px]">
        <div className="bg-[#263057] p-[30px_80px] md:p-[30px] rounded-md text-white ph:p-[10px_20px]">
            ...
            <form action="" className="flex flex-wrap ld:block">
                <input type="text" name="" className="lg:w-[80%] lg:mb-[10px] w-[35%] p-[10px_20px] rounded-md mr-[30px] text-black ph:w-[100%] ph:mb-[10px]" placeholder="+992 ___-___-___" />
                <input type="text" name="" className="lg:w-[80%] w-[35%] p-[10px_20px] rounded-md mr-[30px] text-black ph:w-[100%] ph:mb-[10px]" placeholder="Как вас зовут?" />
                ...
                <button type="submit" className="md:p-[10px_30px] xl:mt-[10px] p-[10px_60px] bg-[#6984F0] rounded-full ph:w-[100%] ph:mb-[10px]">Жду звонка</button>
            </form>
